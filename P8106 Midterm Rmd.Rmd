...
#norose
rf.pred.norose <- predict(rf.fit.rose, newdata = stroke_df_no_na[-trRows,], type = "prob")[,1]
ctree.pred.norose <- predict(ctree.fit.rose, newdata = stroke_df_no_na[-trRows,], type = "prob")[,1]
xgboost.pred.norose <- predict(xgboost.fit.rose, newdata = stroke_df_no_na[-trRows,], type = "prob")[,1]
ridge.pred.norose <- predict(ridge.fit.rose, newdata = stroke_df_no_na[-trRows,], type = "prob")[,1]
...
roc.gbmA.norose <- roc(stroke_df_no_na$stroke[-trRows], xgboost.pred.norose)
